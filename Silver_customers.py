...
df = (
    spark.read
        .format("parquet")
        .load("abfss://bronze@databricksete3.dfs.core.windows.net/customers")
)
...
df.write.mode("append").format("delta").save("abfss://silver@databricksete3.dfs.core.windows.net/customers")
...
# MAGIC USING DELTA
# MAGIC LOCATION 'abfss://silver@databricksete3.dfs.core.windows.net/customers'
