...
df = spark.read.format("parquet")\
    .load("abfss://bronze@databricksete3.dfs.core.windows.net/orders")
...
df.write.format("delta").mode("append").save("abfss://silver@databricksete3.dfs.core.windows.net/orders") 
...
# MAGIC USING DELTA
# MAGIC LOCATION 'abfss://silver@databricksete3.dfs.core.windows.net/orders'